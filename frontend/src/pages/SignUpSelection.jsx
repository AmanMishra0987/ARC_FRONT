  ...
  const roles = [
    {
      ...
      image:
        "https://tse4.mm.bing.net/th?id=OIP.5NMegaCCOfM2AAAnz3s3zAHaEK&pid=Api&P=0&h=180", // Replace with actual image
    },
    {
      id: 2,
  ...
  return (
    <div className="h-screen bg-gradient-to-b from-black to-purple-900 flex flex-col items-center text-white p-6">
      ...
      <motion.button
        ...
        className="bg-purple-600 p-4 mt-4 rounded-lg text-lg font-medium hover:bg-purple-700 transition-all"

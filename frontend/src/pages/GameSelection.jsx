...
const GameSelection = () => {
  ...
  const games = [
    {
      ...
      name: "BGMI / PUBG",
      image:
        "https://tse4.mm.bing.net/th?id=OIP.5NMegaCCOfM2AAAnz3s3zAHaEK&pid=Api&P=0&h=180",
    },
    {
      id: 2,
  ...
  return (
    <div className="h-screen bg-gradient-to-b from-black to-purple-900 flex flex-col items-center text-white p-6">
      ...
      <div className="grid grid-cols-2 justify-center gap-4 mt-6 min-w-2 max-w-md">
        {games
          .filter((game) =>
          ...
          .map((game) => (
            <motion.div
              ...
              className={`relative flex flex-col items-center cursor-pointer rounded-lg p-3 h-15 bg-black bg-opacity-30 border 
              ${
        ...
        <motion.button
          ...
          className="bg-purple-600 w-full py-3 ml-15 rounded-lg text-lg font-medium hover:bg-purple-700 transition-all"
      ...
      <p
        ...
        onClick={() => console.log("Skipped Step")}
      >
        Skip This Step
      </p>
    </div>
